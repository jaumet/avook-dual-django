    ...
    translations_start = {
        'ca': {
            ...
            'description': "<p class='dual-meta'>A0–A1 · Accés 3 mesos · <strong>19 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos breus i molt guiats</li><li>✔ Mètode Dual frase a frase (L1↔L2)</li><li>✔ Pensat per perdre la por des del primer dia</li></ul>"
        },
        'en': {
            'name': 'Dual Start',
            'description': "<p class='dual-meta'>A0–A1 · 3-month access · <strong>19 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Short and highly guided texts</li><li>✔ Dual method sentence by sentence (L1↔L2)</li><li>✔ Designed to lose fear from day one</li></ul>"
        },
        'es': {
            'name': 'Dual Start',
            'description': "<p class='dual-meta'>A0–A1 · Acceso 3 meses · <strong>19 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos breves y muy guiados</li><li>✔ Método Dual frase a frase (L1↔L2)</li><li>✔ Pensado para perder el miedo desde el primer día</li></ul>"
        },
        'fr': {
            'name': 'Dual Start',
            'description': "<p class='dual-meta'>A0–A1 · Accès 3 mois · <strong>19 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textes courts et très guidés</li><li>✔ Méthode Dual phrase par phrase (L1↔L2)</li><li>✔ Conçu pour perdre la peur dès le premier jour</li></ul>"
        },
        'de': {
            'name': 'Dual Start',
            'description': "<p class='dual-meta'>A0–A1 · 3 Monate Zugang · <strong>19 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Kurze und sehr geführte Texte</li><li>✔ Duale Methode Satz für Satz (L1↔L2)</li><li>✔ Entwickelt, um die Angst vom ersten Tag an zu verlieren</li></ul>"
        },
        'it': {
            'name': 'Dual Start',
            'description': "<p class='dual-meta'>A0–A1 · Accesso 3 mesi · <strong>19 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Testi brevi e molto guidati</li><li>✔ Metodo Dual frase per frase (L1↔L2)</li><li>✔ Pensato per perdere la paura dal primo giorno</li></ul>"
        },
        'pt': {
            'name': 'Dual Start',
            'description': "<p class='dual-meta'>A0–A1 · Acesso 3 meses · <strong>19 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos curtos e muito guiados</li><li>✔ Método Dual frase a frase (L1↔L2)</li><li>✔ Projetado para perder o medo desde o primeiro dia</li></ul>"
        }
    }
    ...
    translations_progress = {
        'ca': {
            ...
            'description': "<p class='dual-meta'>A2–B1 · Accés 3 mesos · <strong>29 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos de 3–5 minuts</li><li>✔ Consolidació de comprensió i ritme</li><li>✔ Pas natural cap a la llengua funcional</li></ul>"
        },
        'en': {
            'name': 'Dual Progress',
            'description': "<p class='dual-meta'>A2–B1 · 3-month access · <strong>29 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Texts of 3–5 minutes</li><li>✔ Consolidation of comprehension and rhythm</li><li>✔ Natural step towards functional language</li></ul>"
        },
        'es': {
            'name': 'Dual Progress',
            'description': "<p class='dual-meta'>A2–B1 · Acceso 3 meses · <strong>29 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos de 3–5 minutos</li><li>✔ Consolidación de comprensión y ritmo</li><li>✔ Paso natural hacia el lenguaje funcional</li></ul>"
        },
        'fr': {
            'name': 'Dual Progress',
            'description': "<p class='dual-meta'>A2–B1 · Accès 3 mois · <strong>29 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textes de 3–5 minutes</li><li>✔ Consolidation de la compréhension et du rythme</li><li>✔ Pas naturel vers une langue fonctionnelle</li></ul>"
        },
        'de': {
            'name': 'Dual Progress',
            'description': "<p class='dual-meta'>A2–B1 · 3 Monate Zugang · <strong>29 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Texte von 3–5 Minuten</li><li>✔ Festigung des Verständnisses und des Rhythmus</li><li>✔ Natürlicher Schritt zur funktionalen Sprache</li></ul>"
        },
        'it': {
            'name': 'Dual Progress',
            'description': "<p class='dual-meta'>A2–B1 · Accesso 3 mesi · <strong>29 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Testi di 3–5 minuti</li><li>✔ Consolidamento della comprensione e del ritmo</li><li>✔ Passo naturale verso una lingua funzionale</li></ul>"
        },
        'pt': {
            'name': 'Dual Progress',
            'description': "<p class='dual-meta'>A2–B1 · Acesso 3 meses · <strong>29 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos de 3–5 minutos</li><li>✔ Consolidação da compreensão e do ritmo</li><li>✔ Passo natural para a língua funcional</li></ul>"
        }
    }
    ...
    translations_advanced = {
        'ca': {
            ...
            'description': "<p class='dual-meta'>B2–C1 · Accés 3 mesos · <strong>36 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos de 5–12 minuts</li><li>✔ Comprensió profunda i vocabulari avançat</li><li>✔ Ideal per perfeccionar la llengua</li></ul>"
        },
        'en': {
            'name': 'Dual Advanced',
            'description': "<p class='dual-meta'>B2–C1 · 3-month access · <strong>36 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Texts of 5–12 minutes</li><li>✔ Deep comprehension and advanced vocabulary</li><li>✔ Ideal for perfecting the language</li></ul>"
        },
        'es': {
            'name': 'Dual Advanced',
            'description': "<p class='dual-meta'>B2–C1 · Acceso 3 meses · <strong>36 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos de 5–12 minutos</li><li>✔ Comprensión profunda y vocabulario avanzado</li><li>✔ Ideal para perfeccionar el idioma</li></ul>"
        },
        'fr': {
            'name': 'Dual Advanced',
            'description': "<p class='dual-meta'>B2–C1 · Accès 3 mois · <strong>36 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textes de 5–12 minutes</li><li>✔ Compréhension approfondie et vocabulaire avancé</li><li>✔ Idéal pour perfectionner la langue</li></ul>"
        },
        'de': {
            'name': 'Dual Advanced',
            'description': "<p class='dual-meta'>B2–C1 · 3 Monate Zugang · <strong>36 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Texte von 5–12 Minuten</li><li>✔ Tiefes Verständnis und fortgeschrittener Wortschatz</li><li>✔ Ideal zur Perfektionierung der Sprache</li></ul>"
        },
        'it': {
            'name': 'Dual Advanced',
            'description': "<p class='dual-meta'>B2–C1 · Accesso 3 mesi · <strong>36 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Testi di 5–12 minuti</li><li>✔ Comprensione profonda e vocabolario avanzato</li><li>✔ Ideale per perfezionare la lingua</li></ul>"
        },
        'pt': {
            'name': 'Dual Advanced',
            'description': "<p class='dual-meta'>B2–C1 · Acesso 3 meses · <strong>36 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Textos de 5–12 minutos</li><li>✔ Compreensão profunda e vocabulário avançado</li><li>✔ Ideal para aperfeiçoar a língua</li></ul>"
        }
    }
    ...
    translations_full = {
        'ca': {
            ...
            'description': "<p class='dual-meta'>A0–C1 · Accés 6 mesos · <strong>49 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ De principiant absolut a avançat</li><li>✔ Màxima flexibilitat de combinacions</li><li>✔ Tot el mètode Dual, sense límits</li></ul>"
        },
        'en': {
            'name': 'Dual Full Access',
            'description': "<p class='dual-meta'>A0–C1 · 6-month access · <strong>49 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ From absolute beginner to advanced</li><li>✔ Maximum flexibility of combinations</li><li>✔ The entire Dual method, without limits</li></ul>"
        },
        'es': {
            'name': 'Dual Full Access',
            'description': "<p class='dual-meta'>A0–C1 · Acceso 6 meses · <strong>49 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ De principiante absoluto a avanzado</li><li>✔ Máxima flexibilidad de combinaciones</li><li>✔ Todo el método Dual, sin límites</li></ul>"
        },
        'fr': {
            'name': 'Dual Full Access',
            'description': "<p class='dual-meta'>A0–C1 · Accès 6 mois · <strong>49 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Du débutant absolu à avancé</li><li>✔ Flexibilité maximale des combinaisons</li><li>✔ Toute la méthode Dual, sans limites</li></ul>"
        },
        'de': {
            'name': 'Dual Full Access',
            'description': "<p class='dual-meta'>A0–C1 · 6 Monate Zugang · <strong>49 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Vom absoluten Anfänger bis zum Fortgeschrittenen</li><li>✔ Maximale Flexibilität der Kombinationen</li><li>✔ Die gesamte Dual-Methode, ohne Grenzen</li></ul>"
        },
        'it': {
            'name': 'Dual Full Access',
            'description': "<p class='dual-meta'>A0–C1 · Accesso 6 mesi · <strong>49 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Da principiante assoluto ad avanzato</li><li>✔ Massima flessibilità di combinazioni</li><li>✔ L'intero metodo Dual, senza limiti</li></ul>"
        },
        'pt': {
            'name': 'Dual Full Access',
            'description': "<p class='dual-meta'>A0–C1 · Acesso 6 meses · <strong>49 €</strong></p>"
                           ...
                           "<ul class='dual-features'><li>✔ Do iniciante absoluto ao avançado</li><li>✔ Máxima flexibilidade de combinações</li><li>✔ Todo o método Dual, sem limites</li></ul>"
        }
    }
